import MemoryBase from "twilio/lib/rest/MemoryBase";
import Version from "twilio/lib/base/Version";
import { BulkContext } from "twilio/lib/rest/memory/v1/bulk";
import { ConversationSummaryListInstance, ConversationSummaryContext } from "twilio/lib/rest/memory/v1/conversationSummary";
import { DataMappingListInstance, DataMappingContext } from "twilio/lib/rest/memory/v1/dataMapping";
import { EventListInstance } from "twilio/lib/rest/memory/v1/event";
import { IdentifierListInstance, IdentifierContext } from "twilio/lib/rest/memory/v1/identifier";
import { IdentityResolutionSettingContext } from "twilio/lib/rest/memory/v1/identityResolutionSetting";
import { ImportListInstance, ImportContext } from "twilio/lib/rest/memory/v1/import";
import { LookupListInstance } from "twilio/lib/rest/memory/v1/lookup";
import { ObservationListInstance, ObservationContext } from "twilio/lib/rest/memory/v1/observation";
import { OperationListInstance } from "twilio/lib/rest/memory/v1/operation";
import { ProfileListInstance, ProfileContext } from "twilio/lib/rest/memory/v1/profile";
import { RecallListInstance } from "twilio/lib/rest/memory/v1/recall";
import { RevisionListInstance } from "twilio/lib/rest/memory/v1/revision";
import { StoreListInstance } from "twilio/lib/rest/memory/v1/store";
import { TraitListInstance } from "twilio/lib/rest/memory/v1/trait";
import { TraitGroupListInstance, TraitGroupContext } from "twilio/lib/rest/memory/v1/traitGroup";
